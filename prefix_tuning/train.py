...
from common import PrefixDataset, CausalCollator, filter_examples_for_adapter, synthesize_routing_rules, default_adapter_specs, AdapterSpec

def load_examples(path):
    with open(path, "r", encoding="utf-8") as f:
        return json.load(f)

def train_one_adapter(base_model_name, tokenizer, examples, spec):
